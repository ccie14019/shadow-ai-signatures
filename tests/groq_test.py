#!/usr/bin/env python3
"""Groq API SDK JA4 Signature Test"""
...
try:
    ...
    print("=" * 60)
    print("Testing Groq API SDK TLS Signature Capture")
    print("=" * 60)
    print(f"Python version: {sys.version}")
    print()
    
    print("Creating Groq client with fake API key...")
    client = Groq(
        api_key="gsk_fake-key-for-signature-capture"
    )
    ...
    print("ERROR: Failed to import Groq SDK")
    print()
    print("Install with:")
