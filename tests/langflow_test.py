#!/usr/bin/env python3
"""LangFlow JA4 Signature Test"""

import sys

try:
    # LangFlow is primarily a UI tool, but has API capabilities
    import langflow  # noqa: F401
    import requests
    
    print("=" * 60)
    print("Testing LangFlow TLS Signature Capture")
    print("=" * 60)
    ...
    print("ERROR: Failed to import LangFlow")
    print()
    print("Install with:")
